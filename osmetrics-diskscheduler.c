...
static int osmetrics_diskscheduler_fill_table(THD *thd, TABLE_LIST *tables, Item *cond)
{
...
static int osmetrics_diskscheduler_table_init(void *ptr)
{
  ST_SCHEMA_TABLE *schema_table= (ST_SCHEMA_TABLE*)ptr;
  schema_table->fields_info= osmetrics_diskscheduler_table_fields;
  schema_table->fill_table= osmetrics_diskscheduler_fill_table;
  return 0;
}

mysql_declare_plugin(os_metrics_diskscheduler)
{
  MYSQL_INFORMATION_SCHEMA_PLUGIN,
  &osmetrics_diskscheduler_table_info,                /* type-specific descriptor */
  "OS_DISKSCHEDULER",                      /* table name */
  "Michael Patrick",                 /* author */
  "OS Metrics Disk Scheduler INFORMATION_SCHEMA table", /* description */
  PLUGIN_LICENSE_GPL,                /* license type */
  osmetrics_diskscheduler_table_init,                 /* init function */
  NULL,
  0x0001,                            /* version = 0.1 */
